...
#SMTP_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST = '10.2.0.15'
EMAIL_HOST_USER = 'smtp@facturacion.finkok.com'
EMAIL_HOST_PASSWORD = '!%01AsporT%!smtp'
EMAIL_PORT = 587
...
FK_CANCEL_URL = 'https://facturacion.finkok.com/servicios/soap/cancel.wsdl'
...
FK_USERNAME = 'alexis@mtzmedina.me'
FK_PASSWORD = 'ChangeMe1$'
...
THREADS_PACKAGES_PROCESSING = 40
...
COLUMNS_STAMPING = "serial as NumeroOrden, taxpayer_id as RFCEmisor, rtaxpayer_id as RFCReceptor, uuid as UUID, emission_date as FechaFactura, type as TipoComprobante, currency as Moneda, payment_method as MetodoDePago, payment_way as FormaDePago, discount as Descuento, tax as Impuestos, total as Total"
...
PACKAGES_BK = Path('/data/soriana_packages')
