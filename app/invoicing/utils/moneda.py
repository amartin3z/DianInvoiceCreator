...
def numero_a_letras(numero):
    #set_trace()
    numero_entero = int(Decimal(numero))
    ...
    parte_decimal = str(numero).split('.')[1] if '.' in str(numero) else '00'

    letras_decimal = '%s/100 M.N.' % parte_decimal
    #if parte_decimal > 9:
    ...
    resultado = '%s %s %s' % (resultado, moneda, letras_decimal)
    return resultado
