...
class Comprobante(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    #def export(self, outfile, level, namespace_='cfdi:', name_='Comprobante', namespacedef_='', pretty_print=True):
    def export(self, outfile, level, namespace_='cfdi:', name_='Comprobante', namespacedef_='xmlns:cfdi="http://www.sat.gob.mx/cfd/3"', schemaLocation=' xsi:schemaLocation="http://www.sat.gob.mx/cfd/3 http://www.sat.gob.mx/sitio_internet/cfd/3/cfdv33.xsd"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='cfdi:', name_='Comprobante'):
        ...
        if self.TipoCambio is not None and 'TipoCambio' not in already_processed:
            ...
            outfile.write(' TipoCambio=%s' % (quote_attrib(self.TipoCambio), ))
    ...
    def exportChildren(self, outfile, level, namespace_='cfdi:', name_='Comprobante', fromsubclass_=False, pretty_print=True):
        ...
        if self.Complemento is not None:
            self.Complemento.export(outfile, level, namespace_, name_='Complemento', pretty_print=pretty_print)
...
class ComercioExterior(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='cfdi:', name_='ComercioExterior', namespacedef_='xmlns:cfdi="http://www.sat.gob.mx/cfd/3"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        outfile.write(' xsi:schemaLocation="http://www.sat.gob.mx/cfd/3 http://www.sat.gob.mx/sitio_internet/cfd/3/cfdv33.xsd"')
        outfile.write(' xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"')
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='ComercioExterior')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='cfdi:', name_='ComercioExterior', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='cfdi:', name_='ComercioExterior'):
        if self.Version is not None and 'Version' not in already_processed:
            already_processed.add('Version')
            outfile.write(' Version=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Version), input_name='Version')), ))
    ...
    def exportChildren(self, outfile, level, namespace_='cfdi:', name_='ComercioExterior', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ConceptoType(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='cfdi:', name_='ConceptoType'):
        ...
        if self.Cantidad is not None and 'Cantidad' not in already_processed:
            ...
            outfile.write(' Cantidad=%s' % (quote_attrib(self.Cantidad), ))
...
class InformacionAduaneraType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='cfdi:', name_='InformacionAduaneraType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class CuentaPredialType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='cfdi:', name_='CuentaPredialType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ComplementoConceptoType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, anytypeobjs_=None, ns_=None):
        self.original_tagname_ = None
        self.ns_ =ns_
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='cfdi:', name_='ComplementoConceptoType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_=self.ns_, name_='ComplementoConceptoType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='cfdi:', name_='ComplementoConceptoType'):
        pass
    def exportChildren(self, outfile, level, namespace_='cfdi:', name_='ComplementoConceptoType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ParteType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='cfdi:', name_='ParteType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='cfdi:', name_='ParteType'):
        ...
        if self.Cantidad is not None and 'Cantidad' not in already_processed:
            already_processed.add('Cantidad')
            outfile.write(' Cantidad=%s' % (quote_attrib(self.Cantidad), )) #Colocada
            #outfile.write(' Cantidad="%s"' % self.gds_format_float(self.Cantidad, input_name='Cantidad'))
        if self.Unidad is not None and 'Unidad' not in already_processed:
            already_processed.add('Unidad')
            outfile.write(' Unidad=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Unidad), input_name='Unidad')), ))
...
class InformacionAduaneraType1(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='cfdi:', name_='InformacionAduaneraType1', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class RetencionesType3(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='cfdi:', name_='RetencionesType3', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class RetencionType4(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='cfdi:', name_='RetencionType4', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TrasladosType5(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='cfdi:', name_='TrasladosType5', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TrasladoType6(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='cfdi:', name_='TrasladoType6', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ComplementoType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='cfdi:', name_='ComplementoType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_=self.ns_, name_='ComplementoType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='cfdi:', name_='ComplementoType'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='ComplementoType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class EmisorType7(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='cfdi:', name_='EmisorType7', namespacedef_='xmlns:cfdi="http://www.sat.gob.mx/cfd/3"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='cfdi:', name_='EmisorType7', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='cfdi:', name_='EmisorType7'):
    ...
    def exportChildren(self, outfile, level, namespace_='cfdi:', name_='EmisorType7', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ReceptorType8(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='cfdi:', name_='ReceptorType8', namespacedef_='xmlns:cfdi="http://www.sat.gob.mx/cfd/3"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='cfdi:', name_='ReceptorType8', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='cfdi:', name_='ReceptorType8'):
        if self.NumRegIdTrib is not None and 'NumRegIdTrib' not in already_processed:
            already_processed.add('NumRegIdTrib')
            outfile.write(' NumRegIdTrib=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.NumRegIdTrib), input_name='NumRegIdTrib')), ))
    def exportChildren(self, outfile, level, namespace_='cfdi:', name_='ReceptorType8', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class DestinatarioType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='cfdi:', name_='DestinatarioType', namespacedef_='xmlns:cfdi="http://www.sat.gob.mx/cfd/3"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='cfdi:', name_='DestinatarioType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='cfdi:', name_='DestinatarioType'):
        if self.NumRegIdTrib is not None and 'NumRegIdTrib' not in already_processed:
            already_processed.add('NumRegIdTrib')
            outfile.write(' NumRegIdTrib=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.NumRegIdTrib), input_name='NumRegIdTrib')), ))
        if self.Nombre is not None and 'Nombre' not in already_processed:
            already_processed.add('Nombre')
            outfile.write(' Nombre=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Nombre), input_name='Nombre')), ))
    def exportChildren(self, outfile, level, namespace_='cfdi:', name_='DestinatarioType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class DomicilioType10(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='cfdi:', name_='DomicilioType10', namespacedef_='xmlns:cfdi="http://www.sat.gob.mx/cfd/3"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='cfdi:', name_='DomicilioType10', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='cfdi:', name_='DomicilioType10'):
        if self.Calle is not None and 'Calle' not in already_processed:
            already_processed.add('Calle')
            outfile.write(' Calle=%s' % (quote_attrib(self.Calle), ))
        if self.NumeroExterior is not None and 'NumeroExterior' not in already_processed:
        ...
        if self.CodigoPostal is not None and 'CodigoPostal' not in already_processed:
            already_processed.add('CodigoPostal')
            outfile.write(' CodigoPostal=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.CodigoPostal), input_name='CodigoPostal')), ))
    def exportChildren(self, outfile, level, namespace_='cfdi:', name_='DomicilioType10', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class MercanciasType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='cfdi:', name_='MercanciasType', namespacedef_='xmlns:cfdi="http://www.sat.gob.mx/cfd/3"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='cfdi:', name_='MercanciasType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='cfdi:', name_='MercanciasType'):
        pass
    def exportChildren(self, outfile, level, namespace_='cfdi:', name_='MercanciasType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class MercanciaType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='cfdi:', name_='MercanciaType', namespacedef_='xmlns:cfdi="http://www.sat.gob.mx/cfd/3"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='cfdi:', name_='MercanciaType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='cfdi:', name_='MercanciaType'):
        if self.NoIdentificacion is not None and 'NoIdentificacion' not in already_processed:
            already_processed.add('NoIdentificacion')
            outfile.write(' NoIdentificacion=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.NoIdentificacion), input_name='NoIdentificacion')), ))
    ...
    def exportChildren(self, outfile, level, namespace_='cfdi:', name_='MercanciaType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class PagoType(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='pago10:', name_='PagoType'):
        ...
        if self.MonedaP is not None and 'MonedaP' not in already_processed:
            ...
            outfile.write(' MonedaP=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.MonedaP), input_name='MonedaP')), ))
...
class DoctoRelacionadoType(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='pago10:', name_='DoctoRelacionadoType'):
        ...
        if self.MonedaDR is not None and 'MonedaDR' not in already_processed:
            ...
            outfile.write(' MonedaDR=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.MonedaDR), input_name='MonedaDR')), ))
        if self.TipoCambioDR is not None and 'TipoCambioDR' not in already_processed:
            ...
            outfile.write(' TipoCambioDR=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.TipoCambioDR), input_name='TipoCambioDR')), ))
