...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:cfdi="http://www.sat.gob.mx/cfd/3" 
  ...
  <!--
	...
	-->
  <xsl:include href="file://{{XSLT_PATH}}/utilerias.xslt"/>
  <!-- 
		En esta sección se define la inclusión de las demás plantillas de transformación para 
		la generación de las cadenas originales de los complementos fiscales 
	-->

  <xsl:include href="file://{{XSLT_PATH}}/ecc12.xslt"/>
  <xsl:include href="file://{{XSLT_PATH}}/donat11.xslt"/>
  <xsl:include href="file://{{XSLT_PATH}}/Divisas.xslt"/>
  <xsl:include href="file://{{XSLT_PATH}}/implocal.xslt"/>
  <xsl:include href="file://{{XSLT_PATH}}/leyendasFisc.xslt"/>
  <xsl:include href="file://{{XSLT_PATH}}/pfic.xslt"/>
  <xsl:include href="file://{{XSLT_PATH}}/TuristaPasajeroExtranjero.xslt"/>
  <xsl:include href="file://{{XSLT_PATH}}/spei.xslt"/>
  <xsl:include href="file://{{XSLT_PATH}}/detallista.xslt"/>
  <!--xsl:include href="file://{{XSLT_PATH}}/cfdiregistrofiscal.xslt"/-->
  <xsl:include href="file://{{XSLT_PATH}}/nomina12.xslt"/>
  <xsl:include href="file://{{XSLT_PATH}}/pagoenespecie.xslt"/>
  <xsl:include href="file://{{XSLT_PATH}}/valesdedespensa.xslt"/>
  <xsl:include href="file://{{XSLT_PATH}}/consumodeCombustibles11.xslt"/>
  <xsl:include href="file://{{XSLT_PATH}}/aerolineas.xslt"/>
  <xsl:include href="file://{{XSLT_PATH}}/notariospublicos.xslt"/>
  <xsl:include href="file://{{XSLT_PATH}}/vehiculousado.xslt"/>
  <xsl:include href="file://{{XSLT_PATH}}/servicioparcialconstruccion.xslt"/>
  <xsl:include href="file://{{XSLT_PATH}}/renovacionysustitucionvehiculos.xslt"/>
  <xsl:include href="file://{{XSLT_PATH}}/certificadodedestruccion.xslt"/>
  <xsl:include href="file://{{XSLT_PATH}}/obrasarteantiguedades.xslt"/>
  <xsl:include href="file://{{XSLT_PATH}}/INE11.xslt"/>
  <xsl:include href="file://{{XSLT_PATH}}/ComercioExterior11.xslt"/>
  <xsl:include href="file://{{XSLT_PATH}}/Pagos10.xslt"/>
  <xsl:include href="file://{{XSLT_PATH}}/IngresosHidrocarburos.xslt"/>
  <xsl:include href="file://{{XSLT_PATH}}/GastosHidrocarburos10.xslt"/>

  <xsl:include href="file://{{XSLT_PATH}}/iedu.xslt" />
  <xsl:include href="file://{{XSLT_PATH}}/ventavehiculos11.xslt" />
  <xsl:include href="file://{{XSLT_PATH}}/terceros11.xslt" />
